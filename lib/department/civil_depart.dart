...
class CivilDepartment extends StatefulWidget {
  static const String id = 'civil_depart';

  @override
  _CivilDepartmentState createState() => _CivilDepartmentState();
}

class _CivilDepartmentState extends State<CivilDepartment> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestoreInstance
          .collection('Books')
          .where('department', isEqualTo: 'Civil')
