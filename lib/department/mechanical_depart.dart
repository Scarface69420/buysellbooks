...
class MechanicalDepartment extends StatefulWidget {
  static const String id = 'mechanical_depart';

  @override
  _MechanicalDepartmentState createState() => _MechanicalDepartmentState();
}

class _MechanicalDepartmentState extends State<MechanicalDepartment> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestoreInstance
          .collection('Books')
          .where('department', isEqualTo: 'Mechanical')
