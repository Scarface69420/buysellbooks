...
class ENTCDepartment extends StatefulWidget {
  static const String id = 'entc_depart';

  @override
  _ENTCDepartmentState createState() => _ENTCDepartmentState();
}

class _ENTCDepartmentState extends State<ENTCDepartment> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestoreInstance
          .collection('Books')
          .where('department', isEqualTo: 'ENTC')
